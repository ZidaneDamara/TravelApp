            ...
            <div class="flex flex-col gap-3 px-4 ">
                ...
                <div class="bg-white p-4 rounded-[26px] flex items-center gap-3">
                    ...
                    <div class="flex flex-col gap-1">
                        <p class="font-semibold text-sm tracking-035 leading-[22px]">{{ $packageBooking->tour->name }}
                        </p>
                ...
                <div class="bg-white p-[16px_24px] rounded-[26px] flex flex-col gap-4">
                    <div class="flex flex-col gap-1">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <span class="text-sm tracking-035 leading-[22px]">{{ $packageBooking->bank->bank_name }}
                            </span>
                        </div>
                    </div>
                    <div class="flex flex-col gap-1">
                    ...
                    <button type="button" id="upload-file"
                        ...
                        <div id="file-info" class=" flex flex-row flex-nowrap gap-3 items-center">
                            ...
                            <p id="placeholder"
                                ...
                                transfer proof</p>
                            <span id="fileName" class="text-sm text-nowrap"></span>
                        </div>
                    </button>
